...
<?php
	...
	{
		$st = "insert into scr3(Time,Picture) values('$_POST[Time]','$_POST[Picture]')";
		if(mysql_query($st)){
...
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" onSubmit="return checkempty(this)" name="form">
  ...
  <p>&nbsp;</p>
      ...
      <tr>
        ...
        <td colspan="3" align="center"><font color="#FFFFFF" size="5">Screen 3 </td>
      </tr>
      <tr>
